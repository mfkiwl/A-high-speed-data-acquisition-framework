...
-- Command     : write_vhdl -force -mode funcsim -rename_top System_util_ds_buf_0_1 -prefix
--               System_util_ds_buf_0_1_ System_util_ds_buf_0_1_sim_netlist.vhdl
...
entity System_util_ds_buf_0_1_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of System_util_ds_buf_0_1_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of System_util_ds_buf_0_1_util_ds_buf : entity is "BUFG";
  attribute C_SIZE : integer;
  attribute C_SIZE of System_util_ds_buf_0_1_util_ds_buf : entity is 1;
end System_util_ds_buf_0_1_util_ds_buf;

architecture STRUCTURE of System_util_ds_buf_0_1_util_ds_buf is
...
entity System_util_ds_buf_0_1 is
  ...
  attribute NotValidForBitStream of System_util_ds_buf_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of System_util_ds_buf_0_1 : entity is "System_util_ds_buf_0_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of System_util_ds_buf_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of System_util_ds_buf_0_1 : entity is "util_ds_buf,Vivado 2018.3";
end System_util_ds_buf_0_1;

architecture STRUCTURE of System_util_ds_buf_0_1 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 50000000, PHASE 0.000, CLK_DOMAIN System_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0";
  attribute x_interface_info of BUFG_O : signal is "xilinx.com:signal:clock:1.0 BUFG_O CLK";
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 50000000, PHASE 0.000, CLK_DOMAIN System_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0";
begin
U0: entity work.System_util_ds_buf_0_1_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
